...
export default function Home() {
  ...
  return <main className="landing">
    ...
    <section className="landing-hero">
      ...
      <div className="landing-actions"><Link href="/play">ログインなしで10ハンド体験</Link><Link href="/login?mode=signup" className="sub">無料登録して500ハンド</Link></div>
    ...
    <section className="landing-cta"><h2>まずは登録なしで10ハンド</h2><p>体験分は、登録後の無料500ハンド枠には含まれません。</p><Link href="/play">今すぐ体験する</Link></section>
    <style jsx>{`
